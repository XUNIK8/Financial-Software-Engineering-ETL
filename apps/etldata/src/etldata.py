...
sys.path.append('c:\\Users\\DELL\\Desktop\\Course\\6861\\')
...
def main(argv):
    try:
        ...
        logging.basicConfig(filename=std_filename, filemode='a', format='%(asctime)s - %(message)s', level=logging.DEBUG)
        logging.info('')
...
def run_extraction(args, config):
    ...
    # Rearrange features and write dataframe
    df_target = etlu.rearrange_feature(df_target, output_config)
...
def run_transformation(args, config):
    ...
    # Prepare aggregate parameters and configuration section.
    transform_config = miscu.eval_elem_mapping(config, 'aggregate')
    
    # Run aggregate ETL feature.
    df_target = etlu.aggregate_feature(df_target, transform_config)
...
if __name__ == '__main__':
    ...
    # Extraction Command:
    # python etldata.py -process hanjiaxu_extraction -log ../etldata.log 
    # -input 'C:\Users\DELL\Desktop\Course\6861\fall2022py\data\hanjiaxu_extraction_input.csv' 
    # -mapping 'C:\Users\DELL\Desktop\Course\6861\fall2022py\data\hanjiaxu_extraction_mapping.xlsx' 
    # -output 'C:\Users\DELL\Desktop\Course\6861\fall2022py\data\hanjiaxu_extraction_output.csv'

    # Transformation Command:
    # python etldata.py -process hanjiaxu_transformation -log ../etldata.log 
    # -input 'C:\Users\DELL\Desktop\Course\6861\fall2022py\data\hanjiaxu_extraction_output.csv' 
    # -mapping 'C:\Users\DELL\Desktop\Course\6861\fall2022py\data\hanjiaxu_extraction_mapping.xlsx' 
    # -output 'C:\Users\DELL\Desktop\Course\6861\fall2022py\data\hanjiaxu_transformation_output.csv'
